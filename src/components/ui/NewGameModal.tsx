                ...
                >
                  ...
                  <div className="meta">
                    ...
                    <div style={{ fontFamily: 'monospace', display: 'flex', gap: '4px', alignItems: 'center' }}>
                      ...
                      {bestTimes[diff]?.autoNotes && <span className="badge-auto" title="Auto Notes Used">AUTO</span>}
                      {bestTimes[diff]?.isAssisted && <span className="badge-hint" title="Logic Hint Used">HINT</span>}
                    </div>
                  </div>
                </div>
              ))}
